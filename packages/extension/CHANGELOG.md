...
- Initial release: save-time validation of React inline styles, Tailwind classes, and CSS modules against a Figma design contract, with diagnostics and "Apply Figma value" quick fixes.
